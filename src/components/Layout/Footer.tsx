...
const ContactUsListItem = styled('li')` 
    display: flex;
    flex-direction: row;
    justify-content: center;
    align-items: flex-start;
...
const SubscribeFormInputContainer = styled('div')`
display: flex;
flex-direction: row;
justify-content: space-between;
width: 100%;
...
const SubscribeIconsList = styled('ul')`
    display: flex;
    // height: 30px;
    gap: 49px;
    justify-content: center;
...
const SubscribeIconsListItem = styled('li')``
